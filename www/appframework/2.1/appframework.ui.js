...
(function($) {
    ...
    ui.prototype = {
        ...
        setLeftSideMenuWidth: function(width) {
            ...
            var css = "@media handheld, only screen and (min-width: 9999999px) {"+
        ...
        goBack: function(delta) {
			...
			$.ui.TopMenuPageCustom(tmpEl.target.replace("#", ""));
			$.ui.disableSideMenu();
			VideoStop ();
        },
        /**
        ...
        */
        ...
        toggleLeftSideMenu: function(force, callback, time, aside) {
            ...
            var els = $.query("#content,  #header, #navbar, #top_menu_page");
        ...
        */
        enableLeftSideMenu: function() {
            $.query("#content, #header, #navbar, #top_menu_page").addClass("hasMenu");
        },
        ...
        */
        enableRightSideMenu: function() {
            $.query("#content, #header, #navbar, #top_menu_page").addClass("hasAside");
        },
        /**
         *
        ...
        disableSplitView:function(){
            $.query("#content, #header, #navbar, #menu, #top_menu_page").removeClass("splitview");
